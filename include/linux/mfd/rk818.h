...
#define RK818_INT_STS_MSK_REG2 0X4d
...
#define rk818_NUM_REGULATORS 13
struct rk818;
...
struct rk818 {
	...
	struct early_suspend rk818_suspend;
...
struct rk818_platform_data {
	int num_regulators;
	int (*pre_init)(struct rk818 *rk818);
	int (*set_init)(struct rk818 *rk818);
