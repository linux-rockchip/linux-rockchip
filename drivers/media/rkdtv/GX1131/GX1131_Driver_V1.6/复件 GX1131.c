...
extern GX1131_STATE GX_I2cReadWrite(u8 WR_flag, u8 ChipAddress,u8 RegAddress,u8 *data, u8 data_number);
	...
	if(GX1131_Read_Lock_Status()>UNLOCKED)		
		{
			...
			if(n_pow!=0)
				{
					snr100=(u32)(10*GX1131_100Log((2048.0/n_pow)+0.5));
...
u8 GX1131_Get_Signal_Strength(void)
{
	...
	//if(GX1131_AGC_POLARITY==1)
		percent=(u8)((409600-100*agc_out)/4096+0.5);
...
u8 GX1131_Get_Signal_Quality(void)
{
	...
	if(percent<30)	percent = (u8)(percent *1.5);
