...
function(git_describe_current _var)
	if(NOT GIT_FOUND)
		set(${_var} "GIT-NOTFOUND"  PARENT_SCOPE)
		return()
	endif()
    ...
    #execute_process(COMMAND "${GIT_EXECUTABLE}" update-index --assume-unchanged Makefile
    #        WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
    #)
    ...
    execute_process(
        ...
        COMMAND grep "^ \\?M"
        COMMAND grep -v Makefile
        COMMAND wc -l
        WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
        OUTPUT_VARIABLE real_changes
    )
    if(real_changes EQUAL "0")
        string(REPLACE "-dirty" "" out ${out})
    endif()
	set(${_var} "${out}" PARENT_SCOPE)
endfunction()
