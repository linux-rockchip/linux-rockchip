...
unsigned int gGPSDbgLevel = GPS_LOG_DBG;

#define GPS_DBG_FUNC(fmt, arg...)    if(gGPSDbgLevel >= GPS_LOG_DBG){ printk(PFX "%s: "  fmt, __FUNCTION__ ,##arg);}
#define GPS_INFO_FUNC(fmt, arg...)   if(gGPSDbgLevel >= GPS_LOG_INFO){ printk(PFX "%s: "  fmt, __FUNCTION__ ,##arg);}
#define GPS_WARN_FUNC(fmt, arg...)   if(gGPSDbgLevel >= GPS_LOG_WARN){ printk(PFX "%s: "  fmt, __FUNCTION__ ,##arg);}
#define GPS_ERR_FUNC(fmt, arg...)    if(gGPSDbgLevel >= GPS_LOG_ERR){ printk(PFX "%s: "  fmt, __FUNCTION__ ,##arg);}
#define GPS_TRC_FUNC(f)              if(gGPSDbgLevel >= GPS_LOG_DBG){ printk(PFX "<%s> <%d>\n", __FUNCTION__, __LINE__);}
