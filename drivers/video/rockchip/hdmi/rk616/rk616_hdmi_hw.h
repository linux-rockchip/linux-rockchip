...
#define HDMIRdReg(addr)						rk616_hdmi_read(addr)
#define HDMIWrReg(addr, val)        		rk616_hdmi_write(addr, val)
#define HDMIMskReg(temp, addr, msk, val)	rk616_hdmi_write_msk(addr, msk, val)

extern void rk616_hdmi_interrupt(struct hdmi *hdmi);
extern void rk616_hdmi_initial(struct rk616_hdmi *rk616_hdmi);
extern int rk616_hdmi_enable(struct hdmi *hdmi);
extern int rk616_hdmi_disable(struct hdmi *hdmi);
extern int rk616_hdmi_detect_hotplug(struct hdmi *hdmi);
extern int rk616_hdmi_read_edid(struct hdmi *hdmi, int block, unsigned char *buff);
extern int rk616_hdmi_insert(struct hdmi *hdmi);
extern int rk616_hdmi_removed(struct hdmi *hdmi);
extern int rk616_hdmi_config_video(struct hdmi *hdmi, struct hdmi_video *vpara);
extern int rk616_hdmi_config_audio(struct hdmi *hdmi, struct hdmi_audio *audio);
extern int rk616_hdmi_control_output(struct hdmi *hdmi, int enable);
#endif
