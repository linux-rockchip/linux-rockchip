#ifndef __RK3028A_CEC_H__
#define __RK3028A_CEC_H__
...
extern int CecInit(struct hdmi *hdmi);
extern void CecIsr(void);
extern void CecSetDevicePA(int devPa);
extern int CecEnumerate(void);
#endif