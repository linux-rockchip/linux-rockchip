...
#endif
	if(rk3190_for_mid) {
        snd_soc_add_controls(codec, rk3190_snd_path_controls,
...
static __devinit int rk3190_platform_probe(struct platform_device *pdev)
{
	DBG("%s\n", __func__);
...
static struct platform_driver rk3190_codec_driver = {
	...
	.remove = __devexit_p(rk3190_platform_remove),
